...
class Rooms(MultiGridEnv):
    ...
    def __init__(
        ...
        self.goal_positions = [(15, 3)]
        self.agent_positions = [(3, 15)]
        ...
        self.width = len(self.map[grid_type][0])
        self.height = len(self.map[grid_type])
    ...
    def _gen_grid(self, width, height, options):
        ...
        for y, row in enumerate(self.map[self.grid_type]):
